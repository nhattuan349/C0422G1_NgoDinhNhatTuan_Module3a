...
public class BanHangRepository implements IBanHangRepository {
    private String jdbcURL = "jdbc:mysql://localhost:3306/ban_hang_khong_status_delete?useSSL=false";
    private String jdbcUsername = "root";
    private String jdbcPassword = "Baydem349";

    private static final String INSERT_BAN_HANG_SQL = "INSERT INTO khach_hang" +
            "(ten_khach_hang,so_dien_thoai,thoi_gian_giao_dich,ma_khuyen_mai) " +
            "VALUES (?, ?, ?, ?);";
    ...
    private static final String SEARCH_BAN_HANG_BY_NAME_AGE_AND_DATE = "SELECT * FROM khach_hang where ten_khach_hang like ? AND so_dien_thoai = ? AND thoi_gian_giao_dich like ?";
    ...
    public void insertBanHang(BanHang banHang) throws SQLException {
        ...
        try (Connection connection = getConnection(); PreparedStatement preparedStatement
                = connection.prepareStatement(INSERT_BAN_HANG_SQL)) {
    ...
    public BanHang selectBanHang(int id) {
        ...
        try (Connection connection = getConnection();
            ...
            while (rs.next()) {
                ...
                banHang = new BanHang(maKhachHang, tenKhachHang, soDienThoai, thoiGianGiaoDich, maKhuyenMai);
            }
        } catch (SQLException e) {
            printSQLException(e);
        }
    ...
    public boolean deleteBanHang(int id) throws SQLException {
        ...
        try (Connection connection = getConnection(); PreparedStatement statement
                = connection.prepareStatement(DELETE_BAN_HANG_SQL);) {
    ...
    public boolean updateBanHang(BanHang banHang) throws SQLException {
        boolean rowUpdated;
        try (Connection connection = getConnection(); PreparedStatement statement
                = connection.prepareStatement(UPDATE_BAN_HANG_SQL);) {
            ...
            statement.setInt(5, banHang.getMaKhachHang());
    ...
    public List<BanHang> findByNamePhoneAndDate(String name, String phone, String date) {
        ...
        try {
            Connection connection = getConnection();
            PreparedStatement preparedStatement = connection.prepareStatement(SEARCH_BAN_HANG_BY_NAME_AGE_AND_DATE);
            preparedStatement.setString(1, "%" + name + "%");
            preparedStatement.setString(2, "%" + phone + "%");
